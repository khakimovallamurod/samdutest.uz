...
require_auth(['teacher']); if($_SERVER['REQUEST_METHOD']!=='POST'){redirect('/olimpiada.uz/test/teacher/tests.php');}
...
$st->close(); flash_set($created>0?'success':'error',$created>0?'Savollar saqlandi.':'Savol topilmadi.'); redirect('/olimpiada.uz/test/teacher/test-questions.php?test_id='.$testId);

...
if($_SERVER['REQUEST_METHOD']!=='POST' || !verify_csrf($_POST['_csrf'] ?? '')){redirect('/olimpiada.uz/test/teacher/tests.php');}
...
flash_set('success','Savol o\'chirildi.'); redirect('/olimpiada.uz/test/teacher/test-questions.php?test_id='.$testId);

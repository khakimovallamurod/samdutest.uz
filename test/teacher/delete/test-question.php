...
if($_SERVER['REQUEST_METHOD']!=='POST' || !verify_csrf($_POST['_csrf'] ?? '')){redirect('/test/teacher/tests.php');}
...
flash_set('success','Savol o\'chirildi.'); redirect('/test/teacher/test-questions.php?test_id='.$testId);
